...
export default function Page() {
  return (
    <div>
      <div className='flex flex-col items-center min-h-screen justify-center gap-12 text-center bg-light-2 text-black'>
        <h1 className='text-5xl font-title font-bold'>New Episodes Every Other Week!</h1>
