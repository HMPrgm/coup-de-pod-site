...
export default function Page() {
  return (
    <div className='bg-hero-pattern bg-cover bg-top'>
      <div className='flex flex-col items-center min-h-screen justify-center gap-12 text-center bg-white bg-opacity-60 text-black'>
        <h1 className='text-5xl font-title font-bold'>New Episodes <span className='line-through'>Every Other Week!</span> Eventually!</h1>
